...
def main():
    ...
    if not from_address or len(from_address.split('@')) != 2:
    ...
    # If running through qfilter, get recipient list from QMAILRCPTS.
        ...
        address_list = os.environ['QMAILRCPTS'].lower().split('\n')[:-1]
    ...
    if Defaults.MAIL_FOLLOWUP_TO and not 'mail-followup-to' in msgout:
